<?php 
    ...
    $nama_file = 'SKTM_' . $userData['nama'] . '_' . $tanggal_pengajuan . '.pdf';
    ...
    $pdf->Cell(115, 7, ' Nomor :400/ 2063 /Des', 0, 1, 'C');
    ...
    $pdf->Line($textX + 122, $textY + 243, $textX + 68 + 8, $textY + 243); // Garis bawah sepanjang teks (dengan spasi tambahan)
