...
$sql = "SELECT id_artikel, gambar, judul_artikel, isi_artikel, tanggal, status FROM artikel";
			...
			<div class="table-data">
				<div class="order">
					<div class="head">
						...
						<button onclick="window.location.href='tambah_artikel.php'"><i class="bx bx-edit-alt">Tambah Artikel</i></button>
					</div>
					<table>
						<thead>
							<tr>
						...
						<tbody>
							...
							if ($result->num_rows > 0) {
								...
								while($row = $result->fetch_assoc()) {
									echo "<tr>";
									echo "<td>" . $no . "</td>";
									echo "<td><img src='img/" . $row['gambar'] . "' alt='Gambar' style='width:50px;'></td>";
									...
									<a href='edit_artikel.php?id_artikel=" . $row['id_artikel'] . "' class='status edit'>Edit</a>
											<span class='status hapus' data-id='" . $row['id_artikel'] . "'>Hapus</span>
										</td>";
									echo "</tr>";
									$no++;
								}
